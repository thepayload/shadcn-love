...
export const Index = {
  "default": {
    ...
    "AlertWrapperDemo": {
      ...
      type: "components:example",
      registryDependencies: ["alert"],
      component: () => import("../src/lib/registry/default/example/AlertWrapperDemo.vue").then((m) => m.default),
      files: ["../src/lib/registry/default/example/AlertWrapperDemo.vue"],
    },
    "AlertWrapperDestructiveDemo": {
      name: "AlertWrapperDestructiveDemo",
      type: "components:example",
      registryDependencies: ["alert"],
      component: () => import("../src/lib/registry/default/example/AlertWrapperDestructiveDemo.vue").then((m) => m.default),
      files: ["../src/lib/registry/default/example/AlertWrapperDestructiveDemo.vue"],
    },
    ...
    "TabsWrapperDemo": {
      name: "TabsWrapperDemo",
      type: "components:example",
      registryDependencies: ["tabs","button","input","label","card"],
      component: () => import("../src/lib/registry/default/example/TabsWrapperDemo.vue").then((m) => m.default),
      files: ["../src/lib/registry/default/example/TabsWrapperDemo.vue"],
    },
    ...
    "Login01": {
      name: "Login01",
      type: "components:pro",
      registryDependencies: ["Logo.vue","Google.vue","Facebook.vue","card","form","input","button","separator"],
    ...
    "AlertWrapperDemo": {
      ...
      type: "components:example",
      registryDependencies: ["alert"],
      component: () => import("../src/lib/registry/new-york/example/AlertWrapperDemo.vue").then((m) => m.default),
      files: ["../src/lib/registry/new-york/example/AlertWrapperDemo.vue"],
    },
    "AlertWrapperDestructiveDemo": {
      name: "AlertWrapperDestructiveDemo",
      type: "components:example",
      registryDependencies: ["alert"],
      component: () => import("../src/lib/registry/new-york/example/AlertWrapperDestructiveDemo.vue").then((m) => m.default),
      files: ["../src/lib/registry/new-york/example/AlertWrapperDestructiveDemo.vue"],
    },
    "AreaChartCustomTooltip": {
      name: "AreaChartCustomTooltip",
      type: "components:example",
    ...
    "TabsWrapperDemo": {
      ...
      type: "components:example",
      registryDependencies: ["tabs","button","input","label","card"],
      component: () => import("../src/lib/registry/new-york/example/TabsWrapperDemo.vue").then((m) => m.default),
      files: ["../src/lib/registry/new-york/example/TabsWrapperDemo.vue"],
    },
    "TagsInputComboboxDemo": {
      name: "TagsInputComboboxDemo",
      type: "components:example",
